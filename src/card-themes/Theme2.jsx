...
let styles = {
  ...
  userCard : {
    ...
    padding:'3vw',
    background:'linear-gradient(175deg, lightgreen, transparent)'
  },
...
const Theme2 = (props) => {
  ...
  return (<>
    {
      card ? <Box sx={{display:'flex', alignItems:'center', justifyContent:'center', background:'red', 
...
export default CardBase(Theme2)